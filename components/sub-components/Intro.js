...
const Intro = () => {
    return (
        <section id='intro' style={{ height: '90vh' }}>
            <div className='flex flex-wrap md:flex-col justify-between mt-48 md:my-16 md:items-center'>
                ...
                <div className='flex justify-center flex-col md:text-center'>
                    ...
                    <div>
                        <button class="bg-white font border py-4 px-6 rounded-sm shadow-xl my-12 md:my-2 focus:outline-none hover:text-gray-700 font- inline-flex items-center hover:shadow-sm border-gray-700 border-opacity-50 hover:border-gray-400 transition duration-300 ease-in-out tracking-wide">
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="paper-airplane w-6 h-6 transform rotate-45 mr-2"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"></path></svg>
                    Get In Touch
                    </button>
                    </div>
                </div>
